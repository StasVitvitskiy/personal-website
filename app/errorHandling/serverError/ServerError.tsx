      ...
      <html lang="en">
        <head>
          ...
          <link
            ...
            rel="stylesheet"
          />
          <link rel="stylesheet" href="/serverError.css" />
        </head>
        <body>
          <main className="page fade-in">
            <div id="top-bar" className="top-bar">
              <span className="action-btn action-btn_primary">
                <a href="/">&larr; back home</a>
              </span>
              <span className="game-counter-panel">
                <span id="game-counter" className="game-counter">
                  99
                </span>{" "}
                little bugs in the code
              </span>
            </div>
            <div className="flex-container" id="error-message">
              <div>
                <h1>500</h1>
                <h2>
                  Oooops! Internal Server Error. That is, something went
                  terribly wrong.
                </h2>
              </div>
              <div>
                <p>
                  Don't worry, we've been reported about that. In the meantime,
                  you can help us{" "}
                  <span className="underlined">catch some nasty bugs</span>. We
                  got you the deadliest of all weapons!
                </p>
              </div>
            </div>
            <div id="game-canvas">
